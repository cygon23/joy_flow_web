...
const testimonials = [
  {
    ...
    image: "👩🏾‍🌾",
    quote:
      "African Joy has transformed my life. Now I have reliable income and can send my children to school. The fair prices and timely payments have given me dignity and hope.",
  ...
  },
  {
    ...
    image: "👩🏿‍💼",
    quote:
      "Working with African Joy means our voices are heard. They treat us as true partners, not just suppliers. Our community has prospered together.",
  ...
  },
  {
    ...
    image: "👩🏾",
    quote:
      "The decentralized collection system has eliminated waste. My milk reaches processing quickly, and I receive fair payment within days. This partnership has changed everything.",
  ...
  },
  {
    ...
    image: "👩🏾‍🌾",
    quote:
      "As a young woman, I was unsure about dairy farming. African Joy provided training, equipment, and a guaranteed market. Now I'm building a future for my family.",
  ...
  },
  {
    ...
    image: "👩🏿",
    quote:
      "The training programs have taught us modern farming techniques while respecting our traditions. We're producing more milk of higher quality than ever before.",
  ...
  },
  {
    ...
    image: "👵🏾",
    quote:
      "I've been farming for 30 years, but African Joy has brought new life to our work. Fair prices, respect, and partnership—this is what we always deserved.",
...
const impactAreas = [
  {
    ...
    description:
      "Fair wages and reliable payments have increased household incomes by an average of 30%, enabling education, healthcare, and business growth.",
    stats: [
      "30% income increase",
      "500+ families supported",
      "Zero delayed payments",
    ],
  },
  {
    title: "Gender Equality",
    description:
      "By partnering exclusively with women farmers, we're breaking barriers and creating leadership opportunities in traditionally male-dominated sectors.",
    stats: [
  ...
  },
  {
    ...
    description:
      "Our decentralized collection and efficient processing reduce waste, carbon emissions, and environmental impact across the supply chain.",
    stats: [
      "30% less waste",
  ...
  },
  {
    ...
    description:
      "Investment in training, equipment, and infrastructure strengthens entire communities, creating ripple effects of prosperity and opportunity.",
    stats: [
      "50+ communities",
      "Training programs",
...
const TestimonialCard = ({ testimonial }) => (
  <Card className='h-full border-2 hover:border-primary transition-colors hover:shadow-xl flex-shrink-0 w-[350px] mx-4'>
...
const ImpactPage = () => {
  ...
  // First 3 testimonials for endless scroll
  const scrollingTestimonials = testimonials.slice(0, 3);
  // Remaining testimonials for static grid
  const staticTestimonials = testimonials.slice(3);
    ...
    <div className='min-h-screen'>
      ...
      <section ref={ref} className='py-24 md:py-32 bg-card'>
        <div className='container mx-auto px-6'>
          ...
          {/* Endless Scrolling Testimonials - First 3 */}
          ...
          <motion.div
            ...
            <div className='absolute bottom-0 left-0 right-0 p-12 text-secondary-foreground'>
              ...
              <p className='text-xl text-secondary-foreground/90'>
                Every liter of milk tells a story of empowerment, partnership,
                and hope
              </p>
            </div>
          </motion.div>
